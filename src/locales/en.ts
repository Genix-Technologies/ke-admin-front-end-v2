...
<ul>
  ...
  <li>Keywords are generated by LLM which is expensive and time consuming.</li>
    ...
    chat: {
      ...
      chatConfiguration: 'Agent Configuration',
      chatConfigurationDescription:
        ' Create chat agent dedicated to your selected knowledge bases.',
      assistantName: 'Name',
      assistantNameMessage: 'Agent name is required',
      descriptionPlaceholder:"",
      namePlaceholder: 'e.g. KE Agent',
