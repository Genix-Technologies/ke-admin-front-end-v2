    ...
    <Card className="w-auto border-none h-3/4">
      <CardContent className="p-4">
        ...
        <div className="flex mt-1 gap-4">
          <span className="text-lg truncate">  Model Config</span>
          <ArrowRight />
        </div>
      </CardContent>
    </Card>
...
export function Banner() {
  return (
    <section className="w-full  bg-cover h-28 rounded-2xl  my-8 flex gap-8 justify-between">
      <div className="h-full w-full text-3xl font-bold items-center inline-flex ml-6">
        Welcome
      </div>
